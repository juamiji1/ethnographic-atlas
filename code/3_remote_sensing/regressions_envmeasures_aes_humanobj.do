...
gen sh_nats_nohumo_atl=sh_natsubj_nohumobj_motif_atl
...
gl X2_int "sh_nats_humo_atl sh_nats_nohumo_atl"
...
esttab aes0 aes1 aes2 aes3 aes4 aes5 using "${tables}/Table_folklore_z_env_humamobj.tex", keep(ae_sh_nature_any_motif_atl ae_sh_nats_humo_atl ae_sh_nats_nohumo_atl) ///
	coeflabels( ///
    ...
    ae_sh_nats_nohumo_atl "\multirow{2}{*}{\shortstack{Share of motifs with at least one nature\\ \hspace{1em}subject and non-human object in a triplet}}") ///
