...
*
*-------------------------------------------------------------------------------
gl X1_int "sh_nature_ppos_act_atl sh_nature_pneg_act_atl"
gl X2_int "sh_nature_epos_act_atl sh_nature_eneg_act_atl"

gl X3_int "sh_nature_ppos_act_atl sh_nature_pneg_act_atl sh_nature_ppos_act_oatl sh_nature_pneg_act_oatl"
gl X4_int "sh_nature_epos_act_atl sh_nature_eneg_act_atl sh_nature_epos_act_oatl sh_nature_eneg_act_oatl"
...
*-------------------------------------------------------------------------------
*Exporting results dummy
esttab aes0 aes1 aes2 aes3 aes4 aes5 using "${tables}/Table_folklore_z_env_verbs.tex", keep(ae_sh_nature_pneg_act_atl ae_sh_nature_ppos_act_atl ae_sh_nature_epos_act_atl ae_sh_nature_eneg_act_atl ) ///
	coeflabels( ///
