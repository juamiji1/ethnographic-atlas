...
AUTHOR: JMJR
TOPIC: Regressions with Nature Exclusive Measures
DATE:

NOTES: Using nature exclusive variables instead of nature any measures
------------------------------------------------------------------------------*/
...
esttab aes0 aes1 aes2 aes3 aes4 aes5 using "${tables}/Table_folklore_z_env_natureonly.tex", keep(ae_sh_nat_socl_atl ae_sh_nat_scl_atl ae_sh_nat_ocl_atl) ///
	coeflabels( ///
