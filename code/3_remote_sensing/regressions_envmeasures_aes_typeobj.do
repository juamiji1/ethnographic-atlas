...
gen sh_nats_humo_atl=sh_natsubj_humobj_motif_atleast
*gen sh_nats_humo_atl=sh_nature_scl_human_ocl_atl
gen sh_nats_supero_atl=sh_nature_scl_super_ocl_atl
gen sh_nats_nato_atl=sh_nature_scl_nature_ocl_atl
gen sh_nats_misso_atl=sh_nature_scl_miss_ocl_atl
...
gl X2_int "sh_nats_humo_atl sh_nats_supero_atl sh_nats_nato_atl sh_nats_misso_atl"
...
esttab aes0 aes1 aes2 aes3 aes4 aes5 using "${tables}/Table_folklore_z_env_typeobj.tex", keep(ae_sh_nature_any_motif_atl ae_sh_nats_humo_atl ae_sh_nats_supero_atl ae_sh_nats_nato_atl ae_sh_nats_misso_atl) ///
	coeflabels( ///
    ...
    ae_sh_nats_humo_atl "\multirow{2}{*}{\shortstack{Share of motifs with at least one nature\\ \hspace{1em}subject and human object in a triplet}}" ///
    ae_sh_nats_supero_atl "\multirow{2}{*}{\shortstack{Share of motifs with at least one nature\\ \hspace{1em}subject and supernatural object in a triplet}}" ///
    ae_sh_nats_nato_atl "\multirow{2}{*}{\shortstack{Share of motifs with at least one nature\\ \hspace{1em}subject and natural object in a triplet}}" ///
    ae_sh_nats_misso_atl "\multirow{2}{*}{\shortstack{Share of motifs with at least one nature\\ \hspace{1em}subject and no object in a triplet}}") ///
